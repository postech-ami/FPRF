...
from plenoxels.models.vgg.Style_function import adaptive_instance_normalization as adain
from plenoxels.models.vgg.Style_function import calc_mean_std, styleLoss, GramMatrix
...
class Net(nn.Module):
    def __init__(self, encoder, decoder):
        ...
        self.conv1 = nn.Sequential(*enc_layers[:1])


        self.enc_to_128 = nn.Sequential(*enc_layers[:11])
    ...
    def encode_to_128_dim(self, input):
        out_1 = self.enc_to_128(input)
